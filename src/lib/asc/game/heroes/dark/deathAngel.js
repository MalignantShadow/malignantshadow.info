...
const featureMap = {
  atDeathsDoor: f("At Death's Door", [6], ({ disableTerms, noParagraph }) => (
  ...
  deathlyVisage: f("Deathly Visage", [3], ({ disableTerms, noParagraph }) => (
    <React.Fragment>
  ...
  lifesteal: f("Lifesteal", [11], ({ disableTerms, noParagraph }) => (
    <React.Fragment>
      <Typography paragraph>
  ...
  neverRepent: f("Never Repent", [17], ({ noParagraph }) => (
    <React.Fragment>
      <Typography paragraph>
